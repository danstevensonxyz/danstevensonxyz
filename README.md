...
Welcome to my personal site, built on top of the <a href="https://github.com/gatsbyjs/gatsby-starter-blog">Gatsby starter blog</a>. 


## 🧐 What's in the box?

The project currently contains three static pages:
- `/` is configured in the file `/src/pages/index.js`
- `/blog` is configured in the file `/src/pages/blog/index.js`
- `/projects` is configured in the file `/src/pages/projects/index.js`

Content pages are markdown files, which live in `/content/markdown/[category-name]/[post-title]`
